...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top py-lg-0 px-lg-5 wow fadeIn" data-wow-delay="0.1s">
        <a href="index.html" class="navbar-brand ms-4 ms-lg-0">
            <h1 class="text-primary m-0">Kopi Toratima Asli Pipikoro</h1>
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            ...
            <div class=" d-none p-4  d-lg-flex">
        ...
        <div class="container">
            <div class="row g-5">
                <div class="col-lg-8 wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <h1 class="display-6 mb-4">Asli Pipikoro, Sigi Sulteng</h1>
                    <p class="mb-2">Toratima berasal dari kata bahasa Kulawi yang artinya diambil atau dipungut dari tanah.</p>
                    <p class="mb-5" style="text-align: justify;">Kopi Toratima adalah kopi robusta khas Sigi, Sulawesi Tengah. Keunikan kopi Toratima terletak pada cara pemilihan biji kopinya. Biji kopi diambil dari lepehan binatang-binatang nokturnal yang memakan buah kopi di malam hari, seperti tarsius, kelelawar, tangali, dll. Biji-biji kopi yang tertinggal di permukaan tanah ini kemudian diolah dan dijadikan kopi Toratima. Walaupun pada awalnya kopi Toratima hanya dikonsumsi masyarakat setempat sebagai suguhan tamu atau kegiatan adat, kopi Toratima kemudian menjadi sajian khas yang dijual ke pelbagai daerah di Sulawesi, seperti di Palu.</p>
                </div>
    ...
    <!-- Testimonial Start -->
    <div class="container-xxl bg-light my-6 py-2 pb-0">
        <div class="container">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="position-relative">
                                <h5 class="text-light mb-0">Bagi masyarakat yang ingin menjadi agen silahkan registrasi terlebih dahulu</h5>
                                <a href="<?= base_url('login/regist') ?>" class="btn btn-dark mt-2 me-2">Registrasi</a>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="position-relative">
